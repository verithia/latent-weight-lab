...
OUTMIX = "mlp.c_proj_outmix"
OUTG12_MIX = "mlp.c_proj_outgroup12_mix"
G12_INMIX = "mlp.c_proj_group12_inmix"
...
def main() -> None:
    specs = [
        ("y800_cproj_mix_100m_01_attn_only", {"block_fht_targets": ATTN}),
        ("y800_cproj_mix_100m_02_plain_outmix", {"block_fht_targets": ATTN + [OUTMIX]}),
        (
            "y800_cproj_mix_100m_03_plain_outmix_colgain",
            {"block_fht_targets": ATTN + [OUTMIX], "block_fht_input_gain_targets": [OUTMIX]},
        ),
        ("y800_cproj_mix_100m_04_outg12_mix", {"block_fht_targets": ATTN + [OUTG12_MIX]}),
        (
            "y800_cproj_mix_100m_05_outg12_mix_colgain",
            {"block_fht_targets": ATTN + [OUTG12_MIX], "block_fht_input_gain_targets": [OUTG12_MIX]},
        ),
        ("y800_cproj_mix_100m_06_group12_inmix", {"block_fht_targets": ATTN + [G12_INMIX]}),
    ]
    tasks = [(name, write(name, **updates)) for name, updates in specs]
    queue_path = CONFIG_DIR / "y800_cproj_mix_100m_queue.tsv"
