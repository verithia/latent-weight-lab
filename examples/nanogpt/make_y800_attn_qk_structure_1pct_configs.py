...
def main() -> None:
    specs = [
        ("y800_attn_qkstruct_100m_01_qk_pair_l1", {"block_fht_targets": ["attn.c_attn.qk"]}),
        ("y800_attn_qkstruct_100m_02_k_headwise_l1", {"block_fht_targets": ["attn.c_attn.k_headwise"]}),
        ("y800_attn_qkstruct_100m_03_qk_headwise_l1", {"block_fht_targets": ["attn.c_attn.qk_headwise"]}),
        (
            "y800_attn_qkstruct_100m_04_qk_pair_cproj_l1",
            {"block_fht_targets": ["attn.c_attn.qk", "attn.c_proj"]},
        ),
        (
            "y800_attn_qkstruct_100m_05_qk_headwise_cproj_l1",
            {"block_fht_targets": ["attn.c_attn.qk_headwise", "attn.c_proj"]},
        ),
        (
            "y800_attn_qkstruct_100m_06_k_headwise_v_cproj_l1",
            {"block_fht_targets": ["attn.c_attn.k_headwise", "attn.c_attn.v", "attn.c_proj"]},
        ),
    ]
    tasks = [(name, write(name, **updates)) for name, updates in specs]
    queue_path = CONFIG_DIR / "y800_attn_qk_structure_1pct_queue.tsv"
