...
def main() -> None:
    specs = [
        ("y800_groupmlp_more_100m_01_attn_only", {"block_fht_targets": ATTN}),
        (
            "y800_groupmlp_more_100m_02_g12_pregain",
            {"block_fht_targets": ATTN + [G12], "block_fht_ffn_pregelu_gain": True},
        ),
        (
            "y800_groupmlp_more_100m_03_cproj_outg12_only",
            {"block_fht_targets": ATTN + [POUT12]},
        ),
        (
            "y800_groupmlp_more_100m_04_cproj_outg16_only",
            {"block_fht_targets": ATTN + [POUT16]},
        ),
        (
            "y800_groupmlp_more_100m_05_g12_pregain_cproj_outg12",
            {"block_fht_targets": ATTN + [G12, POUT12], "block_fht_ffn_pregelu_gain": True},
        ),
        (
            "y800_groupmlp_more_100m_06_g12_pregain_cproj_outg16",
            {"block_fht_targets": ATTN + [G12, POUT16], "block_fht_ffn_pregelu_gain": True},
        ),
        (
            "y800_groupmlp_more_100m_07_g12_cproj_outg12",
            {"block_fht_targets": ATTN + [G12, POUT12]},
        ),
        (
            "y800_groupmlp_more_100m_08_g12_pregain_lr18e4",
            {"block_fht_targets": ATTN + [G12], "block_fht_ffn_pregelu_gain": True, "learning_rate": 0.0018},
        ),
    ]
    tasks = [(name, write(name, **updates)) for name, updates in specs]
    queue_path = CONFIG_DIR / "y800_grouped_mlp_more_100m_queue.tsv"
