...
def main() -> None:
    specs = [
        (
            "y800_stage2_100m_01_cproj_cfc_lat8",
            {"block_fht_targets": ["attn.c_proj", "mlp.c_fc"], "block_fht_latent_ratio": 0.08},
        ),
        (
            "y800_stage2_100m_02_cproj_cfc_lat10",
            {
        ...
        (
            "y800_stage2_100m_03_cproj_cfc_lowrank32",
            {
                "block_fht_targets": ["attn.c_proj", "mlp.c_fc"],
                "block_fht_latent_ratio": 0.08,
        ...
        (
            "y800_stage2_100m_04_cproj_cfc_lat10_lowrank32",
            {
                "block_fht_targets": ["attn.c_proj", "mlp.c_fc"],
                "block_fht_latent_ratio": 0.08,
                "block_fht_latent_ratios": {"attn.c_proj": 0.08, "mlp.c_fc": 0.10},
        ...
        (
            "y800_stage2_100m_05_cproj_cfc_lat10_gainattn",
            {
                "block_fht_targets": ["attn.c_proj", "mlp.c_fc"],
                "block_fht_latent_ratio": 0.08,
                "block_fht_latent_ratios": {"attn.c_proj": 0.08, "mlp.c_fc": 0.10},
    ...
    queue_path = CONFIG_DIR / "y800_stage_cproj_cfc_queue.tsv"
