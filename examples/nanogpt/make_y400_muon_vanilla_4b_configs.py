...
def write(name: str, learning_rate: float) -> str:
    config = dict(BASE)
...
def main() -> None:
    specs = [
        ("y400_muon_vanilla_4b_01_lr16e4", 0.0016),
        ("y400_muon_vanilla_4b_02_lr18e4", 0.0018),
        ("y400_muon_vanilla_4b_03_lr20e4", 0.0020),
    ]
    tasks = [(name, write(name, lr)) for name, lr in specs]
    queue_path = CONFIG_DIR / "y400_muon_vanilla_4b_queue.tsv"
