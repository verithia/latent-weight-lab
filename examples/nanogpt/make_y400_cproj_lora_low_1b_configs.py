...
def with_lr(config: dict[str, Any], learning_rate: float) -> dict[str, Any]:
    ...
    updated["min_lr"] = learning_rate / 50
    return updated
...
def main() -> None:
    specs = [
        ("y400_cproj_lora_low_1b_01_r8_lr18e4", cproj_lora(8, 0.0018)),
        ("y400_cproj_lora_low_1b_02_r16_lr18e4", cproj_lora(16, 0.0018)),
        ("y400_cproj_lora_low_1b_03_r24_lr18e4", cproj_lora(24, 0.0018)),
        ("y400_cproj_lora_low_1b_04_r32_lr18e4", cproj_lora(32, 0.0018)),
        ("y400_cproj_lora_low_1b_05_r8_lr22e4", cproj_lora(8, 0.0022)),
        ("y400_cproj_lora_low_1b_06_r16_lr22e4", cproj_lora(16, 0.0022)),
        ("y400_cproj_lora_low_1b_07_r24_lr22e4", cproj_lora(24, 0.0022)),
        ("y400_cproj_lora_low_1b_08_r32_lr22e4", cproj_lora(32, 0.0022)),
    ]
    tasks = [(name, write(name, updates)) for name, updates in specs]
    queue_path = CONFIG_DIR / "y400_cproj_lora_low_1b_queue.tsv"
