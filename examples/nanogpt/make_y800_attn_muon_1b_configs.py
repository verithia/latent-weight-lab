...
def main() -> None:
    specs = [
        ("y800_muon_1b_r2_01_vanilla_lr10e4", {"method": "baseline", "learning_rate": 0.0010}),
        ("y800_muon_1b_r2_02_vanilla_lr14e4", {"method": "baseline", "learning_rate": 0.0014}),
        ("y800_muon_1b_r2_03_vanilla_lr18e4", {"method": "baseline", "learning_rate": 0.0018}),
        (
            "y800_muon_1b_r2_04_qk_headwise_cproj_l1_lr18e4",
            {"method": "block_fht", "block_fht_targets": ["attn.c_attn.qk_headwise", "attn.c_proj"]},
        ),
        (
            "y800_muon_1b_r2_05_mix25_cproj_l1_lr18e4",
    ...
    queue_path = CONFIG_DIR / "y800_attn_muon_1b_queue.tsv"
