...
def main() -> None:
    specs = [
        ("y800_attn_qkmix_100m_01_mix25_l1", {"block_fht_targets": ["attn.c_attn.qk_mix25_headwise"]}),
        ("y800_attn_qkmix_100m_02_mix50_l1", {"block_fht_targets": ["attn.c_attn.qk_mix50_headwise"]}),
        ("y800_attn_qkmix_100m_03_mix75_l1", {"block_fht_targets": ["attn.c_attn.qk_mix75_headwise"]}),
        (
            "y800_attn_qkmix_100m_04_mix25_cproj_l1",
            {"block_fht_targets": ["attn.c_attn.qk_mix25_headwise", "attn.c_proj"]},
        ),
        (
            "y800_attn_qkmix_100m_05_mix50_cproj_l1",
            {"block_fht_targets": ["attn.c_attn.qk_mix50_headwise", "attn.c_proj"]},
        ),
        (
            "y800_attn_qkmix_100m_06_mix75_cproj_l1",
            {"block_fht_targets": ["attn.c_attn.qk_mix75_headwise", "attn.c_proj"]},
        ),
    ]
    tasks = [(name, write(name, **updates)) for name, updates in specs]
    queue_path = CONFIG_DIR / "y800_attn_qk_mix_1pct_queue.tsv"
