...
def main() -> None:
    ...
    specs = [
        (
            "y800_fullattn_muon_1b_01_qk_headwise_v_cproj_lr18e4",
            {"block_fht_targets": qk_full, "learning_rate": 0.0018},
        ),
        (
            "y800_fullattn_muon_1b_02_qk_headwise_v_cproj_lr14e4",
            {"block_fht_targets": qk_full, "learning_rate": 0.0014},
        ),
        (
            "y800_fullattn_muon_1b_03_qk_headwise_v_cproj_lr22e4",
            {"block_fht_targets": qk_full, "learning_rate": 0.0022},
        ),
        (
            "y800_fullattn_muon_1b_04_mix25_v_cproj_lr18e4",
            {"block_fht_targets": mix_full, "learning_rate": 0.0018},
        ),
    ]
    tasks = [(name, write(name, **updates)) for name, updates in specs]
    queue_path = CONFIG_DIR / "y800_fullattn_muon_1b_queue.tsv"
